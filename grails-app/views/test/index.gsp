		...
		<div id="list-test" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="testdata" title="${message(code: 'test.testdata.label', default: 'Testdata')}" />
				...
				<g:each in="${testInstanceList}" status="i" var="testInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${testInstance.id}">${fieldValue(bean: testInstance, field: "testdata")}</g:link></td>
